...
namespace курсач.User_Controls
{
    public partial class Clients : UserControl
    {
        ...
        private void AddBox_Click(object sender, EventArgs e)
        {
            ...
            Classes.DBConn.NewRecord($"INSERT INTO clients(name) " +
                                            $"VALUES ('')");
            Reload();
        }
        ...
        {
            Classes.DBConn.DeleteUser("DELETE FROM clients WHERE id='", id_selected_rows);
            Reload();
        }
